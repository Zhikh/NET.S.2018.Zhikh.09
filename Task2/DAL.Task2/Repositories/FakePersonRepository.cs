...
{
    public class FakePersonRepository : BaseRepository<Person>, IRepository<Person>
    {
        ...
        internal override Person FindEntity(string value)
        {
        ...
        internal override void Update(Person entity)
        {
        ...
        internal override bool IsInvalid(Person entity)
