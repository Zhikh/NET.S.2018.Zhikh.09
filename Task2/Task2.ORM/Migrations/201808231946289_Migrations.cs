    ...
    public partial class Migrations : DbMigration
    {
        public override void Up()
        {
            CreateTable(
                ...
                .ForeignKey("Person.Person", t => t.OwnerId, cascadeDelete: true)
                .Index(t => t.OwnerId)
                .Index(t => t.TypeId);
                ...
                c => new
                    {
                        ...
                        Number = c.String(nullable: false, maxLength: 10, fixedLength: true),
                        Authority = c.String(nullable: false, maxLength: 50),
                        IssueDate = c.DateTime(nullable: false, precision: 7, storeType: "datetime2"),
                        IdNumber = c.String(nullable: false, maxLength: 50, fixedLength: true),
                    })
                .PrimaryKey(t => t.PersonId)
                .ForeignKey("Person.Person", t => t.PersonId)
                .Index(t => t.PersonId);
